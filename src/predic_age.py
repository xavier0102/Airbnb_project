...
df_user = pd.read_csv('/home/jaketoruk/Documents/Kaggle_Competition/airbnb/airbnb-recruiting-new-user-bookings/train_users_2.csv', parse_dates=['date_first_booking', 'date_account_created'])
